...
function lengthOrSquare(value: Value) {
...
const userInput: Value | null = prompt(
  "Enter a value as either a string or a number"
);
if (userInput === null) {
  throw new Error("Invalid input");
}

const parsedValue: Value = isNaN(Number(userInput))
  ? userInput
  : Number(userInput);
